...
namespace Dove
{
    public partial class App : Application
    {
        ...
        public static int savedCounter = 0;
        public static string PickYourPlace="";
        public static string MyReceiveString = "";
        public static ObservableCollection<MySelectPhotoList> MyPho { get; set; }
        ...
        {
            public string news_list { get; set; }
        ...
        {
            public List<FleetsCollection> news_list { get; set; }
        }
        ...
        public App()
        {
            ...
            MyPho = new ObservableCollection<MySelectPhotoList>();
        }
